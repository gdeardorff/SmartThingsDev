 ...
 *  Gary Deardorff
 *  Originally based on: Schwark Satyavolu
                         Allan Klein's (@allanak) and Mike Maxwell's code
 *
 *  Usage:
 * 
...
metadata {
	definition (name: "Alarm.com Switch", namespace: "gdeardorff", author: "Gary Deardorff") {
	capability "Switch"
